...
.set TO_LT,16; .set TO_GT,8; .set TO_EQ,4; .set TO_LLT,2; .set TO_LGT,1
	...
	.rename	H.17..__srterm__0__Fv,".__srterm__0__Fv"
	.rename	H.19..__srterm__1__Fv,".__srterm__1__Fv"
	.rename	H.25.NO_SYMBOL{TC},""
	.rename	H.27.NO_SYMBOL{RO},""
	.rename	E.29.__STATIC{RW},"_$STATIC"
	.rename	H.31.__STATIC{TC},"_$STATIC"
	.rename	H.35.__sinit80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv{TC},"__sinit80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv"
	.rename	H.39.__srterm__0__Fv{TC},"__srterm__0__Fv"
	.rename	H.43.__srterm__1__Fv{TC},"__srterm__1__Fv"
	.rename	H.47.__sterm80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv{TC},"__sterm80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv"
	.rename	H.51.swap__3stdHd_RdT1_v{TC},"swap__3stdHd_RdT1_v"
	...
	.lglobl	H.17..__srterm__0__Fv   
	.lglobl	H.19..__srterm__1__Fv   
	.globl	.swap__3stdHd_RdT1_v    
	.lglobl	H.27.NO_SYMBOL{RO}      
	.lglobl	E.29.__STATIC{RW}       
...
.__sinit80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv:# 0x00000000 (H.11.NO_SYMBOL)
	stm	r30,-8(SP)
	mfspr	r0,LR
	l	r30,T.31.__STATIC(RTOC)
	l	r31,T.25.NO_SYMBOL(RTOC)
	oril	r3,r30,0x0000
	lfd	fp0,24(r30)
	lfd	fp2,32(r30)
	lfs	fp1,64(r31)
	...
	oril	r0,r0,0x0000
	l	r3,T.39.__srterm__0__Fv(RTOC)
	bl	.atexit{PR}
	oril	r0,r0,0x0000
	cal	r3,1(r30)
	bl	.__ct__Q2_3std6_WinitFv{PR}
	oril	r0,r0,0x0000
	l	r3,T.43.__srterm__1__Fv(RTOC)
	bl	.atexit{PR}
	oril	r0,r0,0x0000
	lfd	fp0,88(r31)
	lfd	fp1,80(r31)
...
.__sterm80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv:# 0x0000010c (H.11.NO_SYMBOL+0x10c)
	stu	SP,-64(SP)
	mfspr	r0,LR
	l	r3,T.43.__srterm__1__Fv(RTOC)
	st	r0,72(SP)
	...
	oril	r0,r0,0x0000
	cmpi	0,r3,0
	bc	BO_IF,CR0_EQ,__L13c
	l	r3,T.39.__srterm__0__Fv(RTOC)
	bl	.unatexit{PR}
	oril	r0,r0,0x0000
	b	__L14c
__L13c:                                 # 0x0000013c (H.11.NO_SYMBOL+0x13c)
	bl	H.19..__srterm__1__Fv
	l	r3,T.39.__srterm__0__Fv(RTOC)
	bl	.unatexit{PR}
	oril	r0,r0,0x0000
__L14c:                                 # 0x0000014c (H.11.NO_SYMBOL+0x14c)
	cmpi	0,r3,0
	bc	BO_IF,CR0_EQ,__L164
	l	r12,72(SP)
	cal	SP,64(SP)
	mtspr	LR,r12
	bcr	BO_ALWAYS,CR0_LT
__L164:                                 # 0x00000164 (H.11.NO_SYMBOL+0x164)
	bl	H.17..__srterm__0__Fv
	l	r12,72(SP)
	cal	SP,64(SP)
	mtspr	LR,r12
	bcr	BO_ALWAYS,CR0_LT
...
# End of traceback table
H.17..__srterm__0__Fv:                  # 0x00000188 (H.11.NO_SYMBOL+0x188)
	cal	r4,2(r0)
	stu	SP,-64(SP)
	mfspr	r0,LR
	l	r3,T.31.__STATIC(RTOC)
	st	r0,72(SP)
...
# End of traceback table
H.19..__srterm__1__Fv:                  # 0x000001c4 (H.11.NO_SYMBOL+0x1c4)
	cal	r4,2(r0)
	stu	SP,-64(SP)
	mfspr	r0,LR
	l	r3,T.31.__STATIC(RTOC)
...
# End of traceback table
.swap__3stdHd_RdT1_v:                   # 0x00000204 (H.11.NO_SYMBOL+0x204)
	lfd	fp0,0(r4)
	lfd	fp1,0(r3)
	stfd	fp0,0(r3)
	stfd	fp1,0(r4)
...
# .data section
	...
	.toc	                        # 0x00000228 
T.35.__sinit80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv:
	.tc	H.35.__sinit80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv{TC},__sinit80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv{DS}
T.31.__STATIC:
	.tc	H.31.__STATIC{TC},E.29.__STATIC{RW}
T.25.NO_SYMBOL:
	.tc	H.25.NO_SYMBOL{TC},H.27.NO_SYMBOL{RO}
T.39.__srterm__0__Fv:
	.tc	H.39.__srterm__0__Fv{TC},__srterm__0__Fv{DS}
T.43.__srterm__1__Fv:
	.tc	H.43.__srterm__1__Fv{TC},__srterm__1__Fv{DS}
T.47.__sterm80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv:
	.tc	H.47.__sterm80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv{TC},__sterm80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv{DS}
T.51.swap__3stdHd_RdT1_v:
	.tc	H.51.swap__3stdHd_RdT1_v{TC},swap__3stdHd_RdT1_v{DS}
...
# End	csect	__sinit80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv{DS}
	...
	.long	.__sterm80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv# "\0\0\001\f"
	.long	TOC{TC0}                # "\0\0\002("
	.long	0x00000000              # "\0\0\0\0"
# End	csect	__sterm80000000_x_2ftmp_2fzeta_2fsrc_2feval_5ftest_2ecpp__Fv{DS}
	...
	.long	H.17..__srterm__0__Fv   # "\0\0\001\210"
	.long	TOC{TC0}                # "\0\0\002("
	.long	0x00000000              # "\0\0\0\0"
# End	csect	__srterm__0__Fv{DS}
	...
	.long	H.19..__srterm__1__Fv   # "\0\0\001\304"
	.long	TOC{TC0}                # "\0\0\002("
	.long	0x00000000              # "\0\0\0\0"
# End	csect	__srterm__1__Fv{DS}
	...
	.long	.swap__3stdHd_RdT1_v    # "\0\0\002\004"
	.long	TOC{TC0}                # "\0\0\002("
	.long	0x00000000              # "\0\0\0\0"
# End	csect	swap__3stdHd_RdT1_v{DS}


	.csect	E.29.__STATIC{RW}, 3    
	...
	.long	0x00000000              # "\0\0\0\0"
	.long	0x00000000              # "\0\0\0\0"
# End	csect	E.29.__STATIC{RW}


	.csect	H.27.NO_SYMBOL{RO}, 3   
